                            ...
                            <div tabindex="-1"
                                ...
                                <div class="multiselect-tags">
                                    ...
                                    @foreach($bakatKerja as $bakat)
                                        <span class="multiselect-tag is-disabled">{{ $bakat->nama_item }}<span class="ml-2"
                            ...
                            <div tabindex="-1"
                                ...
                                <div class="multiselect-tags">
                                    ...
                                    @foreach($minatKerja as $minat)
                                        <span class="multiselect-tag is-disabled">{{ $minat->nama_item }}<span class="ml-2"
                                                wire:click="removeMinatKerja('{{ $minat->kode }}')"><svg
                                                    class="w-4 h-4 text-red-500" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M6 18L18 6M6 6l12 12"></path>
                            ...
                            <div tabindex="-1"
                                ...
                                <div class="multiselect-tags">
                                    ...
                                    @foreach($tempramenKerja as $tempramen)
                                        <span class="multiselect-tag is-disabled">{{ $tempramen->nama_item }}<span
                                                class="ml-2"
                            ...
                            <div tabindex="-1"
                                ...
                                <div class="multiselect-tags">
                                    ...
                                    @foreach($upayaFisik as $upaya)
                                        <span class="multiselect-tag is-disabled">{{ $upaya->nama_item }}<span class="ml-2"
                            ...
                            <div tabindex="-1"
                                ...
                                <div class="multiselect-tags">
                                    ...
                                    @foreach($fungsiPekerjaan as $fungsi)
                                        <span class="multiselect-tag is-disabled">{{ $fungsi->nama_item }}<span class="ml-2"
