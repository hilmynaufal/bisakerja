<div class="w-full bg-white"><!----><!----><!----><!----><!----><!----><!----><!----><!---->
    <div><!---->
        <div>
            <div class="w-full bg-white dark:bg-gray-800">
                <div class="flex w-full">
                    <div class="w-full overflow-hidden transition-shadow duration-300 bg-white rounded shadow-sm">
                        <div class="flex w-full">
                            <div class="w-full mx-auto grid px-6 mb-6">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th
                                                                    ...
                                                                    Penyebab </th><!---->
                                                                <th
                                                                    class="justify-end text-right pr-10 cursor-auto px-2 py-4 bg-gray-50 text-gray-500 capitalize">
                                                                    Aksi
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody class="text-gray-600 text-sm font-light">
                                                            @foreach ($dataResikoBahaya as $item)
                                                                <tr
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        <div class="flex item-right justify-end">
                                                                            <span
                                                                                wire:click="hapusResikoBahaya('{{ $item->id }}')"
            ...
            <form wire:submit="insertResikoBahaya">
                <div class="w-full bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="flex">
                        <div class="flex-initial w-1/2">
                            <div class="block text-sm mb-3 mt-2"><label class="block text-sm px-2 mb-3"><span
                                        class="text-bkn-blue text-base">Nama Resiko <!----></span><input type="text"
                                        wire:model="nama_resiko" placeholder="Masukan Nama Resiko" autocomplete="on"
                    ...
                    <div class="flex">
                        <div class="flex-initial w-1/2">
                            <div class="block text-sm mb-3 mt-2"><label class="block text-sm px-2 mb-3"><span
                                        class="text-bkn-blue text-base">Penyebab <!----></span><input type="text"
                                        wire:model="penyebab" placeholder="Masukan Penyebab" autocomplete="on"
                                        class="block w-full border rounded mt-1 px-2 focus:border-indigo-800 focus:outline-none focus:shadow-outline-indigo form-input"></label><!---->
                            </div>
                        </div>
                        <div class="flex-initial w-1/2">&nbsp;</div>
                    ...
                    <div class="flex">
                        <div class="w-3/4 text-lg leading-6 font-medium text-gray-900 dark:text-white px-2 mb-3 pb-3">
                        </div>
