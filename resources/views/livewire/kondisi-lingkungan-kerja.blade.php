<div class="w-full bg-white"><!----><!----><!---->
    <div>
                                        ...
                                        <div class="w-full">
                                            <div class="w-full overflow-x-scroll overflow-y-scroll">
                                                <table class="w-full table-auto"
                                                    id="table_usulan_kondisi_lingkungan_kerja">
                                                    <thead>
                                                        <tr><!---->
                                                            <th
                                                    ...
                                                    <tbody class="text-gray-600 text-sm font-light">
                                                        @foreach ($dataKondisiLingkunganKerja as $item)
                                                            <tr
                                                                ...
                                                                <td class="justify-start text-left cursor-auto py-2 px-2">
                                                                    <div class="flex item-right justify-end">
                                                                        <span
                                                                            wire:click="editKondisiLingkunganKerja('{{ $item->id }}')"
                                                                            ...
                                                                            Edit </span>
                                                                        <span
                                                                            wire:click="hapusKondisiLingkunganKerja('{{ $item->id }}')"
        ...
        <form wire:submit="{{ $isEditing ? 'updateKondisiLingkunganKerja' : 'insertKondisiLingkunganKerja' }}">
            <div class="w-full bg-white dark:bg-gray-800 pt-5 pb-4 sm:py-6 sm:pb-4">
                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white px-2 mb-3 pb-3">
                    {{ $isEditing ? 'Edit Kondisi Lingkungan Kerja' : 'Kondisi Lingkungan Kerja' }} </h3>
                <div class="block text-sm mb-3 mt-2"><label class="block text-sm px-2 mb-3 mt-2"><span
                            class="text-bkn-blue text-base">Aspek <!----></span><textarea wire:model="aspek"
                            placeholder="Ketik Aspek Disini (maks. 500 Karakter)" autocomplete="on" rows="1"
                ...
                <div class="block text-sm mb-3 mt-2"><label class="block text-sm px-2 mb-3 mt-2"><span
                            class="text-bkn-blue text-base">Faktor <!----></span><textarea wire:model="faktor"
                            placeholder="Ketik Faktor Disini (maks. 500 Karakter)" autocomplete="on" rows="4"
                            class="block w-full border mt-1 px-2 rounded focus:border-indigo-800 focus:outline-none focus:shadow-outline-indigo form-textarea"></textarea></label><!---->
                </div>
                <div class="ml-2"><!----></div>
            </div>
