<div>
    ...
    <div class="mb-4">
        <a onclick="window.open('{{ route('resume-export', ['activeJabatanId' => $activeJabatanId]) }}', '_blank')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Export PDF
        </a>
    </div>
    
    <!-- Field Keterangan Langkah-langkah Save PDF -->
    <div class="mb-6 ml-4 mr-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <h3 class="text-lg font-semibold text-blue-800 mb-3">📋 Panduan Menyimpan Dokumen PDF</h3>
        <div class="text-sm text-gray-700 space-y-2">
            <div class="flex items-start">
                ...
                <div>
                    <strong>Klik tombol "Export PDF"</strong> di atas untuk membuka dokumen dalam tab baru browser
                </div>
            </div>
            <div class="flex items-start">
                ...
                <div>
                    <strong>Setelah dokumen terbuka, tekan Ctrl+P (Windows) atau Cmd+S (Mac)</strong> atau klik ikon printer di browser
                </div>
            </div>
            <div class="flex items-start">
                ...
                <div>
                    <strong>Pilih "Save as PDF"</strong> pada dropdown destination/printer
                </div>
            </div>
            <div class="flex items-start">
                ...
                <div>
                    <strong>Sesuaikan pengaturan sesuai kebutuhan:</strong>
                    <ul class="ml-6 mt-1 space-y-1 text-gray-600">
                        <li>• <strong>Ukuran Kertas:</strong> A4 (21.0 x 29.7 cm) atau Letter (21.6 x 27.9 cm)</li>
                        <li>• <strong>Margin:</strong> Default atau sesuaikan untuk menghemat kertas</li>
                        <li>• <strong>Header & Footer:</strong> Aktifkan jika diperlukan</li>
                        <li>• <strong>Background Graphics:</strong> Aktifkan untuk tampilan yang lebih baik</li>
                    </ul>
                </div>
            </div>
            <div class="flex items-start">
                <span class="bg-blue-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3 mt-0.5">5</span>
                <div>
                    <strong>Pilih lokasi penyimpanan dan beri nama file</strong>, kemudian klik "Save"
                </div>
            </div>
        </div>
        <div class="mt-3 p-2 bg-yellow-50 border border-yellow-200 rounded text-xs text-yellow-800">
            <strong>💡 Tips:</strong> Untuk hasil terbaik, gunakan browser Chrome atau Edge. Pastikan dokumen sudah ter-load sempurna sebelum melakukan export.
        </div>
    </div>
    
    <table class="w-full bg-white text-sm border border-gray-500">
        <tr>
            <td class="bg-gray-50 text-center font-medium py-2">{{ $dataDataJabatan->nama_jabatan }} - {{ $dataDataUnor->unor_atasan_struktural }}
            </td>
        </tr>
        ...
        <tr class="border-t border-gray-500">
            <td class="bg-white px-5 py-2">
                ...
                <div class="flex my-2">
                    ...
                    <div class="w-9/12">{{ implode(', ', array_column($dataPendidikan, 'nama_pendidikan')) }}</div>
                </div>
                <div class="flex my-2">
