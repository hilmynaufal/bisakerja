        ...
        *,
        ...
        .myCanvas {
            ...
            td {
                ...
                border-width: 1px;
                border-style: solid;
                /* Atur nilai padding sesuai kebutuhan Anda */
            }
            ...
            <table class="w-full bg-white text-sm border border-gray-500">
                <tr>
                    <td class="bg-gray-50 text-center font-medium py-2">{{ $dataDataJabatan->nama_jabatan }} -
                        {{ $dataDataUnor->unor_atasan_struktural }}
                    </td>
                </tr>
                ...
                <tr class="border-t border-gray-500">
                    <td class="bg-white px-5 py-2">
                        ...
                        <div class="flex my-2">
                            ...
                            <div class="w-9/12">{{ implode(', ', array_column($dataPendidikan, 'nama_pendidikan')) }}
                            </div>
                        </div>
                        <div class="flex my-2">
                ...
                <tr class="border-t border-gray-500">
                    <td class="bg-gray-50 font-medium px-5 py-2">
                        <div class="flex">
                            <div class="w-1/12">No</div>
                            <div class="w-3/12">Nama Jabatan</div>
                ...
                @foreach ($dataKorelasiJabatan as $korelasiJabatan)
                    <tr class="border-t border-gray-500">
                        <td class="bg-white px-5 py-2">
                            <div class="flex">
                                <div class="w-1/12">{{ $loop->iteration }}</div>
                                <div class="w-3/12">{{ $korelasiJabatan->nama_jabatan ?? '' }}</div>
                ...
                <tr class="border-t border-gray-500">
                    <td class="bg-white">
                        ...
                        <div class="flex my-2">
                            ...
                            <div class="w-7/12">
                                @foreach ($dataBakatKerja as $bakatKerja)
                                    {{ $bakatKerja->kode }} - {{ $bakatKerja->nama_item }}<br>
                                @endforeach
                            </div>
                        </div>
                        <div class="flex my-2">
                            ...
                            <div class="w-7/12">
                                @foreach ($dataTempramenKerja as $tempramenKerja)
                                    {{ $tempramenKerja->kode }} - {{ $tempramenKerja->nama_item }}<br>
                                @endforeach
                            </div>
                        </div>
                        <div class="flex my-2">
                            ...
                            <div class="w-7/12">
                                @foreach ($dataMinatKerja as $minatKerja)
                                    {{ $minatKerja->nama_item }}<br>
                                @endforeach
                            </div>
                        </div>
                        <div class="flex my-2">
                            ...
                            <div class="w-7/12">
                                @foreach ($dataUpayaFisik as $upayaFisik)
                                    {{ $upayaFisik->kode }} - {{ $upayaFisik->nama_item }}<br>
                                @endforeach
                            </div>
                        </div>
                        <div class="flex my-2">
                ...
                <tr class="border-t border-gray-500">
                    <td class="bg-white">
                        @foreach ($dataPrestasiKerja as $index => $prestasi)
                            <div class="flex my-2">
                                <div class="w-1/12 text-center">{{ chr(97 + $index) }}.</div>
                                <div class="w-4/12">{{ $prestasi->uraian_prestasi_kerja }}</div>
                            </div>
                        @endforeach
                    </td>
                </tr>
                ...
                <tr class="border-t border-gray-500">
                    <td class="bg-white px-6 py-2">{{ $dataKelasJabatan[0]->kelas ?? 'Tidak Ada Data' }}</td>
                </tr>
            </table>
        </div>
